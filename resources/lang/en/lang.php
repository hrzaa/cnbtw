...
return [
    ...
    'paragraf home' => "The diversity and culinary delights of the Nusantara are a reflection of the taste of Indonesian culture in addition to natural wealth.",
    'read more' => 'READ MORE',
    'header solo culiners' => 'Solo Culiners',
    'header category' => 'Trends Categories',
    'header category2' => 'All Categories',
    'about us' => 'About Us',
    'header kuliner nusantara' => 'Nusantara Culinary',
    'paragraf kuliner nusantara' => 'Indonesia was originally known as a country that produces spices in abundance. From this spice-based seasoning, many authentic Indonesian specialties are created. And the taste of Indonesian traditional culiner is so diverse and unique because there are many combinations of spices and seasonings combined with different tribes and cultures.',
    'p.k.n typical' => 'Typical',
    'p.k.n culiners' => 'SOLO CULINERS',
